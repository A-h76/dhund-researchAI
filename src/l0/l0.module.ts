...
import { PrismaExtractionMatrixAdapter } from './adapters/prisma/prisma-extraction-matrix.adapter';
...
@Module({
  providers: [
    ...
    { provide: EXTRACTION_MATRIX_STORE, useExisting: PrismaExtractionMatrixAdapter },
